package com.manh.java7.concurrency.chapter2.recipe1.task;
...
public class Account {
	...
	public synchronized void addAmount(double amount) {
		double tmp=balance;
		System.out.println(" start addAmount");
		try {
			Thread.sleep(10);
		...
		tmp+=amount;
		balance=tmp;
		System.out.println(" End addAmount");
	}
	...
	public synchronized void subtractAmount(double amount) {
		double tmp=balance;
		System.out.println(" start subtractAmount");
		try {
			Thread.sleep(10);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		tmp-=amount;
		balance=tmp;
		System.out.println(" End subtractAmount");
	}
