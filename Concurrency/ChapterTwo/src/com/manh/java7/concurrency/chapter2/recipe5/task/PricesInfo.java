package com.manh.java7.concurrency.chapter2.recipe5.task;

import com.manh.concurrent.locks.ReadWriteLock;
import com.manh.concurrent.locks.ReentrantReadWriteLock;
...
public class PricesInfo {
	...
	public double getPrice1()
	{
		...
		lock.readLock().lock();
		System.out.println("inside lock getPrice1");
		double value=price1;
		lock.readLock().unlock();
		System.out.println("outside lock getPrice1");
		return value;
	}
	...
	{
		lock.readLock().lock();
		System.out.println("inside lock getPrice2");
		double value=price2;
		lock.readLock().unlock();
		System.out.println("outside lock getPrice1");
		return value;
	...
	{
		lock.writeLock().lock();
		System.out.println("inside lock setPrices");
		this.price1=price1;
		this.price2=price2;
		lock.writeLock().unlock();
		System.out.println("outside lock setPrices");
	}
}
