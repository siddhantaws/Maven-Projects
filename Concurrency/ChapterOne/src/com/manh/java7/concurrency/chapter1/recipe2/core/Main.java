package com.manh.java7.concurrency.chapter1.recipe2.core;
...
import com.manh.java7.concurrency.chapter1.recipe2.task.Calculator;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		try (FileWriter file = new FileWriter("E:\\DUMP\\log.txt");PrintWriter pw = new PrintWriter(file);){
