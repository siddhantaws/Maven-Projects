package com.manh.java7.concurrency.chapter5.recipe1.core;

import java.util.List;
import java.util.concurrent.ForkJoinPool;
import java.util.concurrent.TimeUnit;

import com.manh.java7.concurrency.chapter5.recipe1.task.Task;
import com.manh.java7.concurrency.chapter5.recipe1.util.Product;
import com.manh.java7.concurrency.chapter5.recipe1.util.ProductListGenerator;
