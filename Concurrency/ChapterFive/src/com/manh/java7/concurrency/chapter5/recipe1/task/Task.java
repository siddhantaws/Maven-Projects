package com.manh.java7.concurrency.chapter5.recipe1.task;
...
public class Task extends RecursiveAction {
	...
	protected void compute() {
		if (last-first<=2) {
			...
			Task t1=new Task(products, first,middle%2 ==0 ? middle : middle+1, increment);
			Task t2=new Task(products,middle%2 ==0 ? middle : middle+1,last, increment);
			invokeAll(t1, t2);	
		}
	}
