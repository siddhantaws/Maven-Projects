...
import com.manh.websocket.data.DrawingDecoder;
import com.manh.websocket.data.DrawingEncoder;
import com.manh.websocket.data.DrawingObject;

@ClientEndpoint(decoders = { DrawingDecoder.class },encoders = { DrawingEncoder.class }
    )
