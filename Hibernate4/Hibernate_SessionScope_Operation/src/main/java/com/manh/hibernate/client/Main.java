...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HibernateUtil.setup("create table Supplier ( id number, name VARCHAR2(20))");
        HibernateUtil.setup("create table Product ( id number, name VARCHAR2(20), description VARCHAR(40), price number,supplier_id number)");
...

        {
            ...
            Query query = session.createQuery("from Product p where p.name= 'Product1'");
