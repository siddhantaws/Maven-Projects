...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HibernateUtil.setup("create table Product ( id number, name VARCHAR(20), description VARCHAR(40), price number,supplier_Id int)");
        ...
        {
            System.out.println("\n---Performing HQL query with LazyFalse-JoinFetch-SupplierAccessed... ");
            String hql = "from Product p left outer join fetch p.supplier as s";
